...
$c_Ltutorial_webapp_people_StevesData$.prototype.init___ = (function() {
  ...
  var jsx$11 = new $c_T2().init___O__O(1, y);
  $m_sci_List$();
  var xs$1 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([0.5, 0.55, 0.65, 0.7, 0.8]);
  ...
  var jsx$10 = new $c_T2().init___O__O(2, y$1);
  $m_sci_List$();
  var xs$2 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([0.55, 0.6, 0.7, 0.75, 0.85]);
  ...
  var jsx$9 = new $c_T2().init___O__O(3, y$2);
  $m_sci_List$();
  var xs$3 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([0.6, 0.75, 0.8, 0.85, 0.9]);
  ...
  var jsx$8 = new $c_T2().init___O__O(4, y$3);
  $m_sci_List$();
  var xs$4 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([0.65, 0.8, 0.85, 0.9, 0.95]);
  var this$19 = $m_sci_List$();
  var cbf$4 = this$19.ReusableCBFInstance$2;
  ...
  var jsx$6 = new $c_T2().init___O__O(6, y$5);
  $m_sci_List$();
  var xs$6 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([0.7, 0.8, 0.85, 0.9, 0.95]);
  var this$27 = $m_sci_List$();
  var cbf$6 = this$27.ReusableCBFInstance$2;
  var y$6 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs$6, cbf$6));
  var jsx$5 = new $c_T2().init___O__O(7, y$6);
  $m_sci_List$();
  var xs$7 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([0.75, 0.85, 0.9, 0.95, 0.975]);
  var this$31 = $m_sci_List$();
  var cbf$7 = this$31.ReusableCBFInstance$2;
  var y$7 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs$7, cbf$7));
  var jsx$4 = new $c_T2().init___O__O(8, y$7);
  $m_sci_List$();
  var xs$8 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([0.8, 0.9, 0.975, 1.05, 1.0]);
  var this$35 = $m_sci_List$();
  var cbf$8 = this$35.ReusableCBFInstance$2;
  var y$8 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs$8, cbf$8));
  var jsx$3 = new $c_T2().init___O__O(9, y$8);
  $m_sci_List$();
  var xs$9 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([0.8, 0.9, 1.0, 107.5, 0.96]);
  var this$39 = $m_sci_List$();
  var cbf$9 = this$39.ReusableCBFInstance$2;
  var y$9 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs$9, cbf$9));
  var jsx$2 = new $c_T2().init___O__O(10, y$9);
  $m_sci_List$();
  var xs$10 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([0.92, 1.0, 1.05, 1.1, 1.05]);
  var this$43 = $m_sci_List$();
  var cbf$10 = this$43.ReusableCBFInstance$2;
  var y$10 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs$10, cbf$10));
  var jsx$1 = new $c_T2().init___O__O(11, y$10);
  $m_sci_List$();
  var xs$11 = new $c_sjs_js_WrappedArray().init___sjs_js_Array([0.95, 1.0, 1.1, 1.16, 1.2]);
  var this$47 = $m_sci_List$();
  var cbf$11 = this$47.ReusableCBFInstance$2;
  var y$11 = $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs$11, cbf$11));
  var array = [jsx$11, jsx$10, jsx$9, jsx$8, jsx$7, jsx$6, jsx$5, jsx$4, jsx$3, jsx$2, jsx$1, new $c_T2().init___O__O(12, y$11)];
...
$c_jl_Character$.prototype.toLowerCase__C__C = (function(c) {
  var thiz = $as_T($g.String.fromCharCode(c));
  var $$this = $as_T(thiz.toLowerCase());
...
$c_Ltutorial_webapp_TutorialApp$.prototype.setupUI__V = (function() {
  ...
  var names = $as_sc_Seq($s_sc_SeqLike$class__sorted__sc_SeqLike__s_math_Ordering__O(this$3, ord));
  var nss = $as_T(names.foldRight__O__F2__O("", new $c_sjsr_AnonFunction2().init___sjs_js_Function2((function(a$2, b$2) {
    var a = $as_T(a$2);
    var b = $as_T(b$2);
    return (("" + new $c_s_StringContext().init___sc_Seq(new $c_sjs_js_WrappedArray().init___sjs_js_Array(["<option value=\"", "\">", "</option>"])).s__sc_Seq__T(new $c_sjs_js_WrappedArray().init___sjs_js_Array([a, a]))) + b)
  }))));
...
$c_Ltutorial_webapp_TutorialApp$.prototype.addClickedMessage__V = (function() {
  ...
  var s = this$2.repr$1;
  var week = this$4.parseInt__T__I__I(s, 10);
  var this$6 = new $c_sci_StringOps().init___T($objectToString((0, $m_Lorg_scalajs_jquery_package$().jQuery$1)("#name").val()));
  ...
  while ((i < len)) {
    var arg1 = this$6.apply__I__O(i);
    if ((arg1 === null)) {
      var x$1$1 = 0
    } else {
      var this$10 = $as_jl_Character(arg1);
      var x$1$1 = this$10.value$1
    };
    var c = $m_jl_Character$().toLowerCase__C__C(x$1$1);
...
$c_Ltutorial_webapp_people_Scores.prototype.hashCode__I = (function() {
  ...
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().doubleHash__D__I(this.deadlift$1));
  acc = $m_sr_Statics$().mix__I__I__I(acc, $m_sr_Statics$().doubleHash__D__I(this.bench$1));
...
$c_sc_AbstractIterable.prototype.foldRight__O__F2__O = (function(z, op) {
  var this$1 = this.iterator__sc_Iterator();
  return $s_sc_TraversableOnce$class__foldRight__sc_TraversableOnce__O__F2__O(this$1, z, op)
});
...
$c_sci_MapLike$ImmutableDefaultKeySet.prototype.apply__O__O = (function(v1) {
  var this$1 = this.$$outer$f;
  return $s_sc_MapLike$class__contains__sc_MapLike__O__Z(this$1, v1)
});
...
$c_sci_MapLike$ImmutableDefaultKeySet.prototype.$$plus__O__sci_Set = (function(elem) {
  var this$1 = this.$$outer$f;
  if ($s_sc_MapLike$class__contains__sc_MapLike__O__Z(this$1, elem)) {
    return this
  } else {
    return $as_sci_Set($as_sc_SetLike($m_sci_Set$().apply__sc_Seq__sc_GenTraversable($m_sci_Nil$())).$$plus$plus__sc_GenTraversableOnce__sc_Set(this).$$plus__O__sc_Set(elem))
  }
});
...
$c_sci_Stream.prototype.foldRight__O__F2__O = (function(z, op) {
  return $s_sc_LinearSeqOptimized$class__foldRight__sc_LinearSeqOptimized__O__F2__O(this, z, op)
});
...
$c_sci_WrappedString.prototype.foldRight__O__F2__O = (function(z, op) {
  var thiz = this.self$4;
  return $s_sc_IndexedSeqOptimized$class__foldr__p0__sc_IndexedSeqOptimized__I__I__O__F2__O(this, 0, $uI(thiz.length), z, op)
});
...
$c_sjs_js_WrappedArray.prototype.foldRight__O__F2__O = (function(z, op) {
  return $s_sc_IndexedSeqOptimized$class__foldr__p0__sc_IndexedSeqOptimized__I__I__O__F2__O(this, 0, $uI(this.array$6.length), z, op)
});
...
$c_scm_ArrayBuffer.prototype.foldRight__O__F2__O = (function(z, op) {
  return $s_sc_IndexedSeqOptimized$class__foldr__p0__sc_IndexedSeqOptimized__I__I__O__F2__O(this, 0, this.size0$6, z, op)
});
...
//# sourceMappingURL=tooting-strength-fastopt.js.map
